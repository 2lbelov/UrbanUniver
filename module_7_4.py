...
formatted_string_4 = "Волшебники данных решили задачи за {} с !".format(team2_time)

formatted_string_5 = f"Команды решили {score_1} и {score_2} задач."
formatted_string_6 = f"Результат битвы: {challenge_result}!"
formatted_string_7 = f"Сегодня было решено {tasks_total} задач, в среднем по {time_avg} секунды на задачу!."
